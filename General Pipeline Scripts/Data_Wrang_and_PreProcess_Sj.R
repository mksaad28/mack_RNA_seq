...
expr_long <- read_tsv("data/michael_saad/featurecounts_results_s_japonicus.txt",
  skip = 1
) |>
  as_tibble() |>
  ...
  mutate(sample = str_remove(
    sample,
    "/cluster/tufts/kaplanlab/msaad01/RNA_Seq/STAR2/output/S_japonicus/"
  ) |>
